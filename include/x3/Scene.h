...
public:
    ...
    virtual void Render(Engine* engine, SDL_GPURenderPass* renderPass) {} // Added renderPass
...
public:
    ...
    void Render(Engine* engine, SDL_GPURenderPass* renderPass); // Added renderPass
