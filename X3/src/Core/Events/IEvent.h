...
namespace X3 
{
	...
	enum struct EventType {
		...
		UPDATE_EDITOR_CAMERA_EVENT,

		WINDOW_RESIZE_EVENT,
		SET_VSYNC_EVENT,

		// PhysicsEvents.h
		PHYSICS_SIMULATION_STARTED_EVENT,
		PHYSICS_SIMULATION_STOPPED_EVENT,
		PHYSICS_COLLISION_ENTER_EVENT,
	...
	inline std::ostream& operator<<(std::ostream& os, EventType type) {
    	switch (type) {
			...
			case EventType::UPDATE_EDITOR_CAMERA_EVENT:		return os << "UPDATE_EDITOR_CAMERA_EVENT";
			case EventType::WINDOW_RESIZE_EVENT:			return os << "WINDOW_RESIZE_EVENT";
			case EventType::SET_VSYNC_EVENT:				return os << "SET_VSYNC_EVENT";
			case EventType::PHYSICS_SIMULATION_STARTED_EVENT:	return os << "PHYSICS_SIMULATION_STARTED_EVENT";
			case EventType::PHYSICS_SIMULATION_STOPPED_EVENT:	return os << "PHYSICS_SIMULATION_STOPPED_EVENT";
			case EventType::PHYSICS_COLLISION_ENTER_EVENT:		return os << "PHYSICS_COLLISION_ENTER_EVENT";
